  ...
  public class RopeLadderComponent : MonoBehaviour, Interactable, Hoverable
  {
    ...
    private void ClimbLadder(Player player)
    {
      ...
      else
      {
        ...
        ((Character) player).AttachStart(this.m_attachPoint, (GameObject) null, true, false, false, "Movement", Vector3.zero);
      }
    }
    ...
    private void UpdateSteps()
    {
      ...
      if (Object.op_Implicit((Object) this.m_mbroot) && Object.op_Implicit((Object) this.m_mbroot.m_moveableBaseShip) && (double) this.m_mbroot.m_moveableBaseShip.m_targetHeight > 0.0 && !this.m_mbroot.m_moveableBaseShip.m_anchored && (double) point.y < (double) this.m_mbroot.GetColliderBottom())
      {
    ...
    public void UpdateIK(Animator animator)
    {
      ...
      if (this.m_targetLeft == RopeLadderComponent.INVALID_STEP && this.m_targetRight == RopeLadderComponent.INVALID_STEP && (double) this.m_currentMoveDir != 0.0)
      {
        ...
        {
          this.m_targetLeft = num1 + ((double) this.m_currentMoveDir > 0.0 ? 2 : -1);
          this.m_leftMoveTime = Time.time;
          this.m_lastMovedLeft = true;
        }
        else
        {
          this.m_targetRight = num1 + ((double) this.m_currentMoveDir > 0.0 ? 2 : -1);
          this.m_rightMoveTime = Time.time;
          this.m_lastMovedLeft = false;
        }
      }
      Vector3 vector3_1 = ((Component) this).transform.TransformPoint(new Vector3(-0.3f, (float) (this.m_currentLeft + 2) * this.m_stepDistance, 0.0f));
      Vector3 vector3_2 = ((Component) this).transform.TransformPoint(new Vector3(-0.2f, (float) this.m_currentLeft * this.m_stepDistance, 0.0f));
      Vector3 vector3_3 = ((Component) this).transform.TransformPoint(new Vector3(0.3f, (float) (this.m_currentRight + 2) * this.m_stepDistance, 0.0f));
      Vector3 vector3_4 = ((Component) this).transform.TransformPoint(new Vector3(0.2f, (float) this.m_currentRight * this.m_stepDistance, 0.0f));
      if (this.m_targetLeft != RopeLadderComponent.INVALID_STEP)
      {
        Vector3 vector3_5 = ((Component) this).transform.TransformPoint(new Vector3(-0.3f, (float) (this.m_targetLeft + 2) * this.m_stepDistance, 0.0f));
      ...
      {
        Vector3 vector3_7 = ((Component) this).transform.TransformPoint(new Vector3(0.3f, (float) (this.m_targetRight + 2) * this.m_stepDistance, 0.0f));
